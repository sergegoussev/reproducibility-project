...
-   Make data available online when possible. Zenodo is a free to use option.
...
-   The explanatory documentation includes docstrings, methodology explainers, dependency information, and more comprehensive guidance for less confident users.
...
-   The data's metadata is comprehensive (e.g. frequency of update, quality controls, license requirements).
