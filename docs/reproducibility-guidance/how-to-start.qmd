...
- Follow a [standard directory structure](https://nhsdigital.github.io/rap-community-of-practice/training_resources/python/project-structure-and-packaging/).
- Manage the [computational environment](https://book.the-turing-way.org/reproducible-research/renv/).
- [Automate the execution of the project](https://book.the-turing-way.org/reproducible-research/make/).
...
- Follow a [style guide](https://book.the-turing-way.org/reproducible-research/code-quality/code-quality-style/).
- [Structure](https://book.the-turing-way.org/reproducible-research/code-quality/) and [document](https://book.the-turing-way.org/reproducible-research/code-documentation/) code in a way that makes it easy to follow.
- Have [automated tests](https://book.the-turing-way.org/reproducible-research/testing/).
