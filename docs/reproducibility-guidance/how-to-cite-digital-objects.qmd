...
When writing a paper, researchers have several options in how to [cite their research compendium](intro.qmd), open data, as well as code they used.

## How to reference datasets you use or other people's code?

The best place to reference other's code or open datasets is in the bibliography. Ideally either has a Digitial Object Identifier (or DOI) so it is unique and can be easily found. There may be harder cases, which are detailed out in more detail in separate articles:
