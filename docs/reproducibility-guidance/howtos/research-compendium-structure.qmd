...
-   The cognitive burden placed on the prerequisite of understanding something not clearly structured means its less likely to be material you learn from. In other words, fewer people will review, evaluate or try what you are doing–meaning that your contribution stays in the generalizable category.
...
-   Ensure all steps can be executed through code (and version control this code with the repository). In other words, make sure there are **no manual steps**. This also means that yous should version control all code, including the data preprocessing code.
...
-   If you're up for it, you could even automate the rendering of the analysis paper, such as through the [manuscripts feature of Quarto](https://quarto-ext.github.io/manuscript-template-jupyter/).
    ...
    -   Using [`makefile` file](https://book.the-turing-way.org/reproducible-research/make/) or [dvc](https://github.com/UN-Task-Team-for-Scanner-Data/price-index-pipeline/tree/main) are other examples of tools to automate the process.
