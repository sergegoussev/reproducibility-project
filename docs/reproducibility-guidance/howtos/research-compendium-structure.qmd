...
├── .gitignore              # File that specifies which files should not be versioned controlled
└── makefile                # Automate the workflow of collecting and processing your data
```
:::
...
A [**Makefile**](https://book.the-turing-way.org/reproducible-research/make/) (or another orchestrator) to automate the data cleaning, processing, and analysis steps that results in the final paper. This helps ensure that you don't have to remember the order of scripts in the `/functions` folder.
