...
![Figure 1: Definitions of Reproducible Research, inspired by [the Turing Way](https://book.the-turing-way.org/reproducible-research/overview/overview-definitions#rr-overview-definitions-reproducibility).](/docs/images/reproducibility-grid.svg){fig-align="center" width="60%"}
...
![Figure 2: Shifting from limited to fuller reproducibility (summarizing the main materials for a research, inspired by [Bontemps and Orozco (2020)](https://link.springer.com/chapter/10.1007/978-3-030-73249-3_30))](images/reserarch-objects-shifting-the-paradigm.svg)
