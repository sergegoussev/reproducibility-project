...
-   **Replicability** can be the backup---if the same data can't be used, try with other data but the same code.
...
::::: fragment
If you are not convinced, what are we missing? Do you have blockers we are not addressing? Is something confusing?
...
![](qrcode.png){fig-align="center" width="30%"}
:::
